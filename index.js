...
function validate(){
    ...
    if(document.myForm.year.value =="" || document.myForm.year.value.length !=4 || document.myForm.year.value >2100 || document.myForm.value <=1900){
        alert("Please provide a valid year of birth! eg 2020");
        document.myForm.year.focus();
        return false;
    }

 else if ( document.myForm.month.value == "" || isNaN( document.myForm.months.value ) ||
 document.myForm.months.value.length !=2 || document.myForm.month.value > 12 || document.myForm.months.value <= 0) {
    ...
    document.myForm.date.value.length !=2 || document.myForm.date.value > 12 || document.myForm.date.value <= 0) {
